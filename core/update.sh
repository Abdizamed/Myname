cd $HOME/ighack/core/                                                                                     
update(){                                                                                                             
if wget --spider https://raw.githubusercontent.com/Abdizamedmoha/ighack/master/update.v3.2 2>/dev/null; then
cd $HOME/ighack/core
rm *.txt
echo "ig" > update.txt
else
...
echo
echo
echo -e "\e[92m          IGHACK UPDATED V3.1 \e[91mWALI UPDATE CUSUB MASO BIXIN...!\e[92m\e[0m"
echo -e "\e[96m                ╔═══════════════════════════════════╗\e[0m"
echo -e "\e[96m                ║    \e[93mIghack\e[96m Wa Ki Ugu Danbeyay\e[93m V3.1\e[96m ║\e[0m"
echo -e "\e[96m                ║     WaLi  Updates \e[93mMasoo Bixin\e[96m     ║\e[0m"
echo -e "\e[96m                ║                                   ║\e[0m"
echo -e "\e[96m                ╚═══════════════════════════════════╝\e[0m"
echo
echo
...
while git clone https://github.com/Abdizamedmoha/IG-HACK 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
